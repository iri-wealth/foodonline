...
def payments(request):
    ...
    if request.headers.get(
            'x-requested-with') == 'XMLHttpRequest' and request.method == 'POST':
        ...
        for i in cart_items:
            if i.fooditem.vendor.user.email not in to_emails:
                ...
                ordered_food_to_vendor = OrderedFood.objects.filter(order=order,
                ...
                context = {
                    ...
                    'vendor_subtotal':
                        order_total_by_vendor(order, i.fooditem.vendor.id)[
                            'subtotal'],
                    'tax_data':
                        order_total_by_vendor(order, i.fooditem.vendor.id)[
                            'tax_dict'],
